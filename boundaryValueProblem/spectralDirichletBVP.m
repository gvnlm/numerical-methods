function yPoints = spectralDirichletBVP(f, xPoints, y0, yn)
% y'' = f(xPoints)
% dirichlet boundary condition at both boundaries
    ...
    % [A]{y} = {c}
        ...
        % {c}
        c = f(xPoints(2:end-1)) - y0*D2(2:end-1, 1) - yn*D2(2:end-1, end);
    
        yPoints(2:end-1) = linsolve(A, c);
